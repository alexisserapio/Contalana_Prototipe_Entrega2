...
## 📱 Descripción  
Este proyecto constituye una version preeliminar de un prototipo funcional de la aplicación móvil **Contalana**, desarrollado de forma nativa para iOS usando **Swift**.  
